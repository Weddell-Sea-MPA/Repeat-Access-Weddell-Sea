###############################################
# STEP 1: CREATE BINARY ACCESSIBILITY MAPS (with CRS check) - RB4
###############################################
#
# Created by FT
# Created on 29/08/2025
# Updated/edited by FT
# Last updated/edited on 18/Aug/2026
#
# PURPOSE OF THIS SCRIPT:
# This is the first stage of the analysis for RB4. It processes every raw ice
...
#
# RUN THIS SCRIPT BEFORE STEP 2, SCRIPT 09.
#
# DISCLAIMER:
...
if (fs::dir_exists(ice_data_path)) {
  ice_data_path = fs::path_abs(ice_data_path)
} else {
...
# Specific to RB4
shapefile_path = fs::path(project_root, "03_original_data", "00_basemaps", "research_blocks", "RB_48_6_4.shp") 
if (fs::file_exists(shapefile_path)) {
  shapefile_path = fs::path_abs(shapefile_path)
}
...
message("\n--- Stage 1: Creating Binary Accessibility Maps (RB4) ---")
...
if (num_remaining == 0) {
  stop("All source files have been processed. You can proceed to Script 09.")
}
...
message("=======================================================\n")
message("Script 08 finished. You can now run Script 09.")